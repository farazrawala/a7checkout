...
<div class="pre loading_div dn">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" enable-background="new 0 0 30 30" xml:space="preserve" width="30" height="30">
      ...
      <?php
if ($ipResponse['country'] == 'PK1' && $_SERVER['REMOTE_ADDR'] != '::1')
{ ?>
...
?>
                              ...
                              <div class="col-md-4 col-xs-4 pl5">
                                 <div class="input-group">
                                    <input  
                                       id="card_cvv"  name="card_cvv" name="cvc" class="form-control" 
...
<div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <div class="input-group">
                           <input type="text" id="card_address" name="card_address" class="form-control" placeholder="Address" value="">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <div class="input-group">
                           <input type="text" id="city_name" name="city_name" class="form-control" placeholder="City" value="">
                     ...
                     <div class="col-md-9">
                        <div class="row">
                           <div class="col-md-6 pr5">
                              <div class="input-group">
                                 <input id="state_name"  name="state_name" class="form-control" 
                           ...
                           <div class="col-md-6 pl5">
                              <div class="input-group">
                                 <input id="zip_code"  name="zip_code" class="form-control" 
                                    placeholder="Zipcode" value="" type="text">
      ...
      $(function(){
         ...
         $(window).bind("pageshow", function(event) {
               ...
               $('#pay_button').click(function(){
                  ...
                  $.ajax({
                        type:"POST",
                        url:  "<?=$apiBaseUrl?>/payarc-process-payment",
                        data,
                        success:function(t){

                            
                            // console.log('_transactionid_',t);
                        ...
                        // }
                            ...
                            // console.log('e.errors',JSON.parse(e.responseText).message);

                            $('.terminal-wrapper').removeClass('loader_class');
                            $('.loading_div').addClass('dn');


                            if(JSON.parse(e.responseText).message != null && JSON.parse(e.responseText).message != '')
                            {
                                // createToast('error',JSON.parse(e.responseText).message);
                                createToast('error','Invalid Card Credentials');
                                return false;
                            }
