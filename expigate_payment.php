...
// Initial Setting Functions
  ...
  function _doPost($query) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://merchantstronghold.transactiongateway.com/api/transact.php");
    // secure.expigate.com
    // https://merchantstronghold.transactiongateway.com/merchants	
...
$gw = new gwapi;
$gw->setLogin("RC4d3J3H436gDaGEF66kEX3vnZVKH2p7");
...
$gw->setBilling(trim('John David'),"Smith","Acme, Inc.","3962 Middlefield Rd","Suite 200", "Beverly Hills",
        "US","10009","US",rand()."5555",rand()."5555",trim('johndavid78663@gmail.com'),
        "www.example.com");
$gw->setShipping(trim('John David'),"Smith","na","3962 Middlefield Rd","Suite Ship", "Beverly Hills",
        "US","10009","US",trim('johndavid78663@gmail.com'));
$gw->setOrder(rand()."1234",rand()."Big Order",1, 2, "PO1234","65.192.14.10");

// echo '<Pre>';
// echo strlen($_POST['card_exp_year']);
// if(strlen($_POST['card_exp_year']) > 2)
$year = 24;
...
$r = $gw->doSale(trim('10'),'4242424242424242',sprintf("%02d", '05').$year,trim('321'));
