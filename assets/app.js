    ...
    paymentPage: function() {
        ...
        $('input[name="payment_type"]').on('change', function() {
            ...
            if ( type == 'recurring' ) {
                ...
                if ( enableSubscriptions == 'authorizenet_only' ) {
        ...
        $('input[name="name"]').on('blur', function() {
            $('input[name="card_name"]').val($(this).val());
        });
    ...
    */
    bootstrap: function() {
        ...
        $('#add_item, #create_invoice').on('shown.bs.modal', function(e) {
            ...
            $(this).find('input[name="number"]').val(Math.floor((Math.random() * 1000000) + 1));
        });
    ...
    */
    ...
    showSuccess: function() {
        swal({
            ...
            confirmButtonText: 'View Payment Invoice',
        ...
        function(isConfirm) {
            if ( isConfirm ) {
                ...
                //window.location = url;
                window.location='https://www.'+app.url+'/authorize-payments/invoice/index.php?key='+app.id;
            }
        });
    },
