...
<div class="container-fluid invoice-container">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 text-sm-end"> <strong>Invoice No:</strong> <?php echo $cxm_merchants['invoice_id'] ?></div>
...
<script>
  $(document).ready(function() {
    ...
    // Generate signature (you can customize this part)
    $("#generateSignatureButton").on("click", function() {
      ...
      // You can use the signatureData as needed, for example, sending it to the server.
    });
